...
SENA_LEARNING_GOOGLE_REDIRECT_URI=https://your-domain.example/sena_learning/auth/google_callback.php
SENA_LEARNING_LINE_CHANNEL_ID=...
SENA_LEARNING_LINE_CHANNEL_SECRET=...
SENA_LEARNING_LINE_REDIRECT_URI=https://your-domain.example/sena_learning/auth/line_callback.php
```
